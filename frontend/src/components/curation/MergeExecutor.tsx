    ...
    <div className="flex flex-col h-full" data-testid="merge-executor">
      ...
      <div className="px-4 py-3 border-t border-gray-200 bg-white">
        <button
          onClick={handleMerge}
          disabled={merging}
          className="w-full text-sm px-4 py-2.5 bg-purple-600 text-on-accent rounded-lg hover:brightness-90 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
