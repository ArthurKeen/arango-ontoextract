        ...
        <>
          {!confirming ? (
            <button
              ...
              disabled={approved === 0}
              className="w-full text-sm px-4 py-2.5 bg-emerald-600 text-on-accent rounded-lg hover:brightness-90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={loading}
                  className="flex-1 text-sm px-4 py-2 bg-emerald-600 text-on-accent rounded-lg hover:brightness-90 disabled:opacity-50 transition-colors font-medium"
